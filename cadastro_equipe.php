...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["cadastrar"])) {
    $nome = $conn->real_escape_string($_POST["Nome"]);
    $pais = $conn->real_escape_string($_POST["Pais_sede"]);
    $stmt = $conn->prepare("INSERT INTO tbequipes (Nome, Pais_sede) VALUES (?, ?)");
  ...
  <div class="container mt-5 mb-5">
    <div class="bg-light border border-primary p-4 rounded">
      ...
      <form method="post">
        ...
        <button type="submit" name="cadastrar border border-primary" class="btn btn-primary w-100">Cadastrar Equipe</button>
      </form>
    </div>
